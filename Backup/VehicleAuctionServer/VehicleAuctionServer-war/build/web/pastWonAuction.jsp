<%-- 
    Document   : pastWonAuction
    Created on : Oct 26, 2015, 7:49:53 PM
                        ...
                        <div class="panel-body" align="center">
                            <%
                                ...
                                if (data.size() == 2) {
                                    ...
                                    out.print("<tr class='success'><td></td><td>Make</td><td>Model</td><td>Manufactured Year</td><td>Winning Bid</td><td>Auction End Time</td><td>Paid Amount</td><td>Due Amount</td><td>Make Payment</td></tr>");
                                    ...
                                    for (int i = 0; i < bids.size(); i++) {
                                        ...
                                        <td><a href='../makePayment?vehicleId=<%= currentVehicle[7] %>' class='btn btn-warning' role='button'>Make Payment</a></td>
                                        <% out.print("</tr>");
                                    }
